angular.module('which.controllers.whichSwoosh', ['which.factory', 'ionic.swoosh.cards'])
...
.controller('CardsCtrl', function($scope, $timeout) {
  ...
  var cardTypes = [
    {
      country: 'What food do you preferasdfasdfasdfasfasdfasfasdfasd?',
      text1: 'Chicken and rice asdfasdfasdfasdfasdfsadfafdsasd',
      text2: 'Steak and lobster',
